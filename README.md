...
ผมไม่สามารถ Deploy บน Vercel ได้เนื่องจากติดปัญหาตรง Error: Command "pnpm install" exited with 1
ซึ่งผมก็ได้ลองทำมาหลายวิธีแล้ว ไม่ว่าจะเป็นการลบแล้วเริ่มทำใหม่ หาข้อมูลเพิ่มเติม แต่ก็ยังไม่สามารถแก้ไขได้
จึงขอเรียนผู้ตรวจว่า logic code การทำงานของผมนั้นทำงานได้ถูกต้องตามที่กำหนดไว้ แต่ไม่ได้สามารถสร้างบน vercel ได้
ขอบคุณครับ - เสริมทรัพย์ บรรจบกาญจน์
